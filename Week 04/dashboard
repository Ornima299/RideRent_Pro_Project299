...
<a href="vehicles.php" class="btn btn-light">
Vehicle List
</a>
...
href="vehicle_details.php?id=<?php echo $row['vehicle_id'];?>"
...
© 2026 DriveEase Vehicle Rental System
