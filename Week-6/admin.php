...
if ($driverQuery) {
    $totalDrivers = mysqli_num_rows($driverQuery);
}
...
// Reviews & Ratings
$totalReviews = 0;
$reviewQuery = mysqli_query($conn, "SELECT * FROM reviews");
if ($reviewQuery) {
    $totalReviews = mysqli_num_rows($reviewQuery);
}

$totalRatings = 4.5; // ডামি ডেটা
?>
...
<div class="main">
    <div class="header">
        ...
        <p>Welcome back, <?php echo isset($_SESSION['user_name']) ? $_SESSION['user_name'] : 'Admin'; ?>!</p>
    </div>
