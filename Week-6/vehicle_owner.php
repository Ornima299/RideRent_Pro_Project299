...
<div class="sidebar">
    ...
    <ul>
        <li class="active"><a href="vehicle_owner.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
...
<div class="main">
    <div class="header">
        <h1><i class="fas fa-tachometer-alt"></i> Vehicle Owner Dashboard</h1>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card text-center">
                <h3><i class="fas fa-calendar-check text-success"></i></h3>
                <h2>0</h2>
                <p>Total Bookings</p>
            </div>
        </div>
